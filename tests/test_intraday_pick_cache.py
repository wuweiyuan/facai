...
def test_intraday_pick_data_source_uses_primary_cache_by_default():
    cfg = {
        "data_source": {
            ...
            "cache_enabled": True,
            "cache_dir": ".cache/custom-akshare",
        }
    }
...
def test_default_config_sets_intraday_pick_primary_cache_dir():
    cfg = load_config("config/default.yaml")

    assert cfg["intraday_pick"]["cache_dir"] == ".cache/akshare"
